...
const seedData = async () => {
  try {
    ...
    await DecorationRental.deleteMany();
    ...
    // 1. Seed Users (an admin and a customer)
    ...
    // Map categories for easier referencing
    const catMap = {};
    categories.forEach(cat => {
      catMap[cat.name] = cat._id;
    });

    // 3. Seed Decoration Packages (Complete services)
    const decorationsData = [
      {
        ...
        category: catMap['Birthday Decorations'],
      ...
      },
      {
        ...
        category: catMap['Baby Shower Decorations'],
      ...
      },
      {
        ...
        category: catMap['Naming Ceremony Decorations'],
    ...
    console.log('Decorations packages seeded...');

    // 4. Seed Decoration Rentals (Individual Props)
    const rentalsData = [
      {
        ...
        category: catMap['LED & Neon Lights'],
        rentalPrice: 600,
      ...
      },
      {
        ...
        category: catMap['Backdrops & Walls'],
        rentalPrice: 2000,
    ...
    await DecorationRental.insertMany(rentalsData);
